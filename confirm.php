...
<body>
  ...
  <main>
    <h2 id="titleH2">Confirm Booking</h2>
  	<!-- Get the input from the form in checkout-page.php using php $_GET -->
  	<?php
  		$fname = $_GET['fname'];
  		$lname = $_GET['lname'];
  		$surfDate = $_GET['surfDate'];
  		$surfTime = $_GET['surfTime'];

  		echo(
  			'<p> Thank you '.$fname.' '.$lname.'.<br>
  			See you on '.$surfDate.' at '.$surfTime.'!<br>
  			Please show your credit card while you check in.</p>'
  		);
  	?>
